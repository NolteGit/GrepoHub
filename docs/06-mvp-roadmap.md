...
The full MVP list is useful as a direction, but it is too large for the immediate next coding session. The current repository should continue with a smaller first milestone:
